...
<img width="859" height="879" alt="image" src="https://github.com/user-attachments/assets/ff827b56-f894-47a9-80ed-55c54ed8db9b" />


---

##  Descripción
La página web presenta la estructura típica de un sitio corporativo de agencia:
- **Header** con nombre y lema de la empresa.
- **Menú de navegación** para acceder a las secciones principales.
- **Hero section** con mensaje inspirador.
- **Servicios** destacados en formato de tarjetas.
- **Sección institucional** sobre la empresa.
- **Bloques temáticos** como *Producciones Audiovisuales* y *Branding*.
...
- Organización modular de secciones.
